...
wavg_3dptv_M_3DPTV_m=12;
%%
root_3dPTV_m='X:\PTV results\3_image.mat';
load(root_3dPTV_m)
figure(11)
...
newy_3DPTV_m(newy_3DPTV_m<brdfiltery_3DPTV_m)=[];
 ...
 % filtering y2
  figure(13)
newU_3DPTV_m((newy_3DPTV_m>Ny-brdfiltery_3DPTV_m))=[];
newV_3DPTV_m((newy_3DPTV_m>Ny-brdfiltery_3DPTV_m))=[];
newW_3DPTV_m((newy_3DPTV_m>Ny-brdfiltery_3DPTV_m))=[];
newz_3DPTV_m((newy_3DPTV_m>Ny-brdfiltery_3DPTV_m))=[];
newx_3DPTV_m((newy_3DPTV_m>Ny-brdfiltery_3DPTV_m))=[];
newy_3DPTV_m((newy_3DPTV_m>Ny-brdfiltery_3DPTV_m))=[];
...
%  filtering x2
 figure(15)
newU_3DPTV_m((newx_3DPTV_m>Nx-brdfilterx_3DPTV_m))=[];
newV_3DPTV_m((newx_3DPTV_m>Nx-brdfilterx_3DPTV_m))=[];
newW_3DPTV_m((newx_3DPTV_m>Nx-brdfilterx_3DPTV_m))=[];
newz_3DPTV_m((newx_3DPTV_m>Nx-brdfilterx_3DPTV_m))=[];
newy_3DPTV_m((newx_3DPTV_m>Nx-brdfilterx_3DPTV_m))=[];
newx_3DPTV_m((newx_3DPTV_m>Nx-brdfilterx_3DPTV_m))=[];
 plot(newy_3DPTV_m,-newU_3DPTV_m,'.r')
%  pause
% filtering z1
 figure(16)
...
% filtering z2
 figure(17)
newU_3DPTV_m((newz_3DPTV_m>Nz-brdfilterz_3DPTV_m))=[];
newV_3DPTV_m((newz_3DPTV_m>Nz-brdfilterz_3DPTV_m))=[];
newW_3DPTV_m((newz_3DPTV_m>Nz-brdfilterz_3DPTV_m))=[];
newx_3DPTV_m((newz_3DPTV_m>Nz-brdfilterz_3DPTV_m))=[];
newy_3DPTV_m((newz_3DPTV_m>Nz-brdfilterz_3DPTV_m))=[];
newz_3DPTV_m((newz_3DPTV_m>Nz-brdfilterz_3DPTV_m))=[];
 plot(newy_3DPTV_m,-newU_3DPTV_m,'.r')
%
 figure(18)
...
% pause(1)
close all
yl=min(newy_3DPTV_m):wavg_3dptv_M_3DPTV_m:max(newy_3DPTV_m);
m=1;
num=1;
for m=1:numel(yl)-1  
...
for k=1:numel(ybin_3DPTV_m) 
    ...
    buff2_3DPTV_m=(up_3DPTV_m{k}>-3 & vp_3DPTV_m{k}<3);
...
for k=1:numel(ybin_3DPTV_m) 
    up_3DPTV_m2(k)=mean(up_3DPTV_mf{k}.^2);       
    vp_3DPTV_m2(k)=mean(vp_3DPTV_mf{k}.^2);
    wp_3DPTV_m2(k)=mean(wp_3DPTV_mf{k}.^2);
    uvp_3DPTV_m(k)=mean(up_3DPTV_mf{k}.*vp_3DPTV_mf{k});   
    uwp_3DPTV_m(k)=mean(up_3DPTV_mf{k}.*wp_3DPTV_mf{k});  
    vwp_3DPTV_m(k)=mean(vp_3DPTV_mf{k}.*wp_3DPTV_mf{k});  
end

for k=1:numel(ybin_3DPTV_m) 
    up_3DPTV_m3(k)=mean(up_3DPTV_mf{k}.^3);       
    vp_3DPTV_m3(k)=mean(vp_3DPTV_mf{k}.^3);     
    wp_3DPTV_m3(k)=mean(wp_3DPTV_mf{k}.^3);   
end

for k=1:numel(ybin_3DPTV_m) 
    up_3DPTV_m4(k)=mean(up_3DPTV_mf{k}.^4);       
    vp_3DPTV_m4(k)=mean(vp_3DPTV_mf{k}.^4);     
    wp_3DPTV_m4(k)=mean(wp_3DPTV_mf{k}.^4);     
end
...
kurtosis_u=up_3DPTV_m4./(up_3DPTV_m2.^2);
kurtosis_v=vp_3DPTV_m4./(vp_3DPTV_m2.^2);
kurtosis_w=wp_3DPTV_m4./(wp_3DPTV_m2.^2);
%%
close all
inil=3; finil=1;
