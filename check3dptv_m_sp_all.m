...
M=0.0233058*1e-3;
%%
wavg_3dptv_m=32;  wavg_3dptv_mz=48;
offsety=0;        offsetz=15;
...
%%
 ...
 root_3dPTV_m=load('cleaned_3dptv_JF_riblet_1.mat');
 data_mdf_3dptv_m=root_3dPTV_m.data_mdf_3dptv_m;
 
%  root_3dPTV_m=load('cleaned_3dptv_JF_riblet_3mat');
Xtotal=data_mdf_3dptv_m(:,1);Ytotal=data_mdf_3dptv_m(:,2);Ztotal=data_mdf_3dptv_m(:,3);
Utotal=data_mdf_3dptv_m(:,4);Vtotal=data_mdf_3dptv_m(:,5);Wtotal=data_mdf_3dptv_m(:,6);
